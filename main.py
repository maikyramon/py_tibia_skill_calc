...
#skill_constant = {'ml': 1600, 'melee': 50, 'distance': 25, 'shielding': 100, 'fishing': 20}
vocation_constants = {
...
def calc_skill():
#b = vocation constant
#c = skill offset  (0 for ml, 10 for other skills)
#Tp = total points
#P = points

# P = A.b^skill-c

#Total points at certain skill level
#TP = A . ((b^skill-c - 1)/b-1)

# skill at certain level
# skill = log(b).((b-1)/A + 1) + c
    global atual
    global desejada
    ...
    messagebox.showinfo("Information",f'b:{b}, A:{A}, skill: {skill}, c: {c}, P: {P}')
    #return 0
...
# skill_constant = {'ml': 1600, 'melee': 50, 'distance': 25, 'shielding': 100, 'fishing': 20}
# no = {'magic' : 4.0, 'melee': 2.0, 'fist': 1.5, 'distance': 2.0, 'distance': 1.5, 'fishing': 1.1}
# ek = {'magic' : 3.0, 'melee': 1.1, 'fist': 1.1, 'distance': 1.4, 'distance': 1.1, 'fishing': 1.1}
# rp = {'magic' : 1.4, 'melee': 1.2, 'fist': 1.2, 'distance': 1.1, 'distance': 1.1, 'fishing': 1.1}
# ms = {'magic' : 1.1, 'melee': 2.0, 'fist': 1.5, 'distance': 2.0, 'distance': 1.5, 'fishing': 1.1}
# ed = {'magic' : 1.1, 'melee': 1.8, 'fist': 1.5, 'distance': 1.8, 'distance': 1.5, 'fishing': 1.1}
